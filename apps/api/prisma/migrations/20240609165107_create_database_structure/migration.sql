-- CreateEnum
CREATE TYPE "ETokenType" AS ENUM ('PASSWORD_RECOVER');

-- CreateEnum
CREATE TYPE "EAccountProvider" AS ENUM ('GITHUB');

-- CreateEnum
CREATE TYPE "ERole" AS ENUM ('ADMIN', 'MEMBER', 'BILLING');
...
CREATE TABLE "members" (
    "id" TEXT NOT NULL,
    "role" "ERole" NOT NULL DEFAULT 'MEMBER',
    "organization_id" TEXT NOT NULL,
    "user_id" TEXT NOT NULL,
